...
<body class="manager">   
<!-- HERO SECTION -->
<div class="mgr-home-overlay" style="background: url('/TestPK/assets/img/admin-db.jpg') no-repeat center center / cover;">
  <div class="mgr-home-content">
    ...
    <p class="mgr-home-description">
      From user management to system analytics, take control of your platform’s backend with clarity, security, and efficiency.
    </p>
  ...
  <div class="mgr-home-mission-box">
    ...
    <p class="mgr-home-mission-text">
      Empower administrators with powerful tools to manage users, ensure data integrity, and maintain seamless operational workflows across the system.
    </p>
  </div>
</div>
...
<aside class="mgr-sidebar ">
      ...
      <a href="index.php" class="nav-link">
        ...
        <div class="mgr-acc" class="nav-link">
          <li>
  ...
  <main class="mgr-main-content ">
      ...
      <div class="mgr-search-filter">
        ...
        <a href="admin_rank.php" class="link-block">
        ...
        <a href="admin_all_tasks.php" class="link-block">
          <div class="mgr-title">
            <br><br>
            <h1>Overall Task Overview</h1><br>
          </div>
        </a>
        ...
        <a href="admin_comp.php" class="link-block">
          <div class="mgr-title">
            <br><br>
            <h1>Company</h1><br>
          </div>
...
<script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const startOffset = currentDay - 3;
            const datesToShow = [];
            
            for (let i = 0; i < 7; i++) {
                const dateOffset = startOffset + i;
                const date = new Date(currentYear, currentMonth, currentDate + dateOffset);
